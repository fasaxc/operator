...
func (in *InstallationSpec) DeepCopyInto(out *InstallationSpec) {
	*out = *in
	...
	if in.TyphaHierarchy != nil {
		in, out := &in.TyphaHierarchy, &out.TyphaHierarchy
		*out = new(TyphaHierarchyConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TyphaHierarchyConfig) DeepCopyInto(out *TyphaHierarchyConfig) {
	*out = *in
	if in.Tier1Count != nil {
		in, out := &in.Tier1Count, &out.Tier1Count
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TyphaHierarchyConfig.
func (in *TyphaHierarchyConfig) DeepCopy() *TyphaHierarchyConfig {
	if in == nil {
		return nil
	}
	out := new(TyphaHierarchyConfig)
